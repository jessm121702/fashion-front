...
const SubscriptionForm = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen -mt-16 pb-12 relative">
      {isLoading && (
        <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
          <div className="w-12 h-12 border-4 border-t-4 border-pink-500 rounded-full animate-spin"></div>
        </div>
      )}
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md lg:max-w-2xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <button
              type="submit"
              className="bg-[#E91E63] text-white font-semibold px-6 py-2 rounded hover:bg-pink-600 transition duration-300"
            >
              Submit
            </button>
          </div>
